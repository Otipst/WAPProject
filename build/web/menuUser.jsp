            ...
            if( !products.isEmpty()){
                for(Product p:products){%>
                    ...
                    <div class="card w-100" style="width: 18rem;">
                        <img class="card-img-top" src="img/menu/<%= p.getImage()%>" alt="Card image cap">
                        <div class="card-body">
                            <h1 class="card-title fw-bold"><%= p.getNama() %></h1>
                            <h4 class="category">Catogory : <%= p.getKategori()%></h4>
                            <h4 class="price">Price : Rp. <%= dcf.format(p.getHarga())%></h4> 
